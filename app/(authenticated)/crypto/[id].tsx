...
import {CartesianChart, Line, useAnimatedPath, useChartPressState} from "victory-native";
                ...
                renderSectionHeader={() => (
                    ...
                    >
                        {categories.map((item, index) => (
                            ...
                            >
                                <Text
                                    style={activeIndex === index ? styles.categoryTextActive : styles.categoryText}>{item}</Text>
                            </TouchableOpacity>
                        ))}
                    </ScrollView>
                )}
